...
export default class TeamPage extends Component {
    ...
    render() {
        const officers = []
        Array.from(this.props.officers).forEach(o => officers.push(<Profile key={o.name} name={o.name} position={o.position} image={o.image} github={o.github} linkedin={o.linkedin} website={o.website} />))
        return (
            <div style={{ '--accent': this.props.accent || '#ff00ff' }}>
                ...
                <div className={styles.info_container}>
                    <Info id={styles.team_info} title='What we do' body={this.props.info} />
                </div>
