...
export class Testimonial extends Component {
  constructor(props) {
    ...
    this.state = {};
    this.mainStyle =
      'flex flex-wrap items-center mb-5 text-base min-w-4/5 max-w-4/5 lg:flex-nowrap';
  ...
  render() {
    ...
    return (
      <div className={this.mainStyle}>
        ...
        <div className={this.containerStyle}>
          <div className={this.titleStyle}>{this.props.name}</div>
          <div className={this.descriptionStyle}>{this.props.description}</div>
        </div>
      </div>
    );
  }
  ...
  render() {
    ...
    return (
      <div style={{ '--accent': this.props.accent || '#ff00ff' }}>
        ...
        <div className={this.infoStyle}>
          <Info title="Program Benefits" body={this.props.benefits} />
        </div>
        <ImageCarousel images={this.props.images} />
        <div className={this.infoStyle}>
          <Info title="How do I join?" body={this.props.how} />
        </div>
        <div className={this.infoStyle}>
          <div
        ...
        {this.props.projects && this.props.projects.length > 0 ? (
          <div className="flex items-center justify-center flex-wrap text-sm mb-14">
            <div className="m-0 text-xl font-bold text-center">
              Past Submissions
            </div>
