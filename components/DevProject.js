...
export default class DevProject extends Component {
  ...
  overlay() {
    ...
    Array.from(this.props.overlay_description || []).forEach((d) => description.push(<div key={d} className={styles.overlay_about_paragraph}>{d}</div>))
    return (
      <div className={styles.overlay}>
        <div className={styles.overlay_card}>
          <div className={styles.overlay_exit}>
            <svg onClick={() => this.setState({ overlay: false })} aria-hidden="true" focusable="false" data-prefix="fas" data-icon="times" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 352 512"><path fill="currentColor" d="M242.72 256l100.07-100.07c12.28-12.28 12.28-32.19 0-44.48l-22.24-22.24c-12.28-12.28-32.19-12.28-44.48 0L176 189.28 75.93 89.21c-12.28-12.28-32.19-12.28-44.48 0L9.21 111.45c-12.28 12.28-12.28 32.19 0 44.48L109.28 256 9.21 356.07c-12.28 12.28-12.28 32.19 0 44.48l22.24 22.24c12.28 12.28 32.2 12.28 44.48 0L176 322.72l100.07 100.07c12.28 12.28 32.2 12.28 44.48 0l22.24-22.24c12.28-12.28 12.28-32.19 0-44.48L242.72 256z"></path></svg>
          </div>
          ...
          <div className={styles.overlay_container}>
            <div className={styles.overlay_contributors_container}>
              <div className={styles.overlay_contributors_title}>Contributors</div>
            ...
            <div className={styles.overlay_about_container}>
              ...
              <div className={styles.overlay_about_paragraph_container}>
                {description || <div className={styles.overlay_about_paragraph}>{this.props.description}</div>}
              </div>
            </div>
          </div>
  ...
  render() {
    ...
    return (
      <div onClick={() => this.setState({ overlay: true })} className={styles.card}>
